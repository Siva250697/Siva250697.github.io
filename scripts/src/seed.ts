...
async function seed() {
  ...
  await db.insert(bikesTable).values([
    ...
    // ── Venumotors ────────────────────────────────────────────────────────
    {
      ...
      batteryCapacityWh: 1920,
      weightKg: "82.0",
      shortDescription: "Agile city scooter with USB charging and a proven 48V/60V setup.",
      description:
        "The Venumotors Spot is designed for effortless urban mobility. It comes with LED headlamp, digital display, disc brakes, telescopic suspension, reverse mode, and USB charging. Choose from 48V 32Ah (40–50 km range, 6–7 hrs charge) or 60V 32Ah (50–60 km range, 6–8 hrs charge) lead acid battery options. 1-year warranty included.",
      imageUrl: "/images/models/spot.png",
      galleryUrls: [],
      features: [
        "LED Headlamp",
        "Digital Display",
    ...
    },
    {
      ...
      batteryCapacityWh: 2304,
      weightKg: "88.0",
      shortDescription: "Bold and powerful scooter with 60V/72V options and stylish graphics.",
      description:
        "The Venumotors Thunder makes a statement on every road. With a powerful motor and two battery options — 60V 32Ah (60–70 km) or 72V 32Ah (70–80 km) — it offers the range and confidence you need. Styled with premium body graphics, LED headlamp, digital meter, disc brakes, telescopic suspension, and reverse mode. 1-year warranty on motor, controller, and battery.",
      imageUrl: "/images/models/thunder.png",
      galleryUrls: [],
      features: [
        "LED Headlamp",
        "Digital Meter",
