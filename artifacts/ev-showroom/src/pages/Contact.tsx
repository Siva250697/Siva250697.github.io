...
const inquiryTypes = ["test_ride", "general", "pricing"] as const;
...
export function Contact() {
  ...
  const initialBikeId = searchParams.get("bikeId") ? Number(searchParams.get("bikeId")) : null;
  const rawType = searchParams.get("type");
  const initialType: InquiryType =
    rawType && inquiryTypes.includes(rawType as InquiryType)
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-display font-bold mb-6">
                Let's Get You <br /><span className="text-primary">Riding</span>
              </h1>
              <p className="text-lg text-muted-foreground mb-12 max-w-md">
                Whether you want to schedule a test ride, request a quote, or just have questions about our electric scooters, our team at Siva Motors is here to help.
              </p>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      22-2202, Kalava Katta Road, Seethaiah Nagar,<br />
                      Vinukonda, Palnadu,<br />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+916300312415" className="text-primary hover:underline font-semibold text-lg">
                      +91 63003 12415
                    </a>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-display font-bold text-lg mb-1">Motto</h4>
                    <p className="text-primary font-semibold">Ride Smart • Ride Green • Save Energy</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              {isSuccess ? (
                ...
                >
                  ...
                  <p className="text-muted-foreground mb-8 text-lg">
                    Thank you for reaching out. Our team at Siva Motors will contact you shortly.
                  </p>
                  <button
                        ...
                        <div className="space-y-2">
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              setValue("bikeId", val === "" ? null : Number(val));
                            }}
                          >
